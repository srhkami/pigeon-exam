 ...
 */
export default function ModalSelectFilter({detailMode = true}: Props) {
  ...
  const defaultValues: FormValues = {
    ...
    comment_is_null: searchParams.get("comment_is_null") || undefined,
