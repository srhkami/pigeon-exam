import {EssayQuestionSimpleData, EssayRecordData} from "@/types/exam-types.ts";
      ...
      <Modal isShow={isShow} onHide={onHide} size='xl' closeButton backdrop={false}>
        ...
        <ModalBody>
          ...
          <div className='text-xs italic opacity-70'>
            ※ 回答內容支援 MD 格式預覽，如何編寫請參考<a href='https://zh.wikipedia.org/zh-tw/Markdown' className='link'>維基百科</a>中範例部分。
          </div>
        </ModalBody>
        <ModalFooter className='gap-1'>
          ...
          {/*{record &&*/}
          {/*  <Button size='sm' style='outline' color='error' onClick={onCheckDelete}>刪除</Button>*/}
          {/*}*/}
